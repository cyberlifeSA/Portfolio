...
**Respuesta:** 203.0.113.46, ListBuckets
...
**Respuesta:** bulk ,RestoreObject

7) ¿Qué cubo fue objetivo en la solicitud de recuperación? (Formato: NombreCubo)

**Respuesta:** lab-bucket-sensitive

8) ¿Cuál es la marca de tiempo de la solicitud de recuperación? (Formato: YYY-MM-DDTHH:MM:SS)

**Respuesta:** 2024-11-29T12:30:00Z

9) ¿Cuáles son los nombres de los archivos descargados por el sujeto? (Formato: archivo1.ext, archivo2.ext)\

![Pasted image 20260602002734](../Fotos/Pasted%20image%2020260602002734.png)  

![Pasted image 20260602003051](../Fotos/Pasted%20image%2020260602003051.png) 

**Respuesta:** project-orion-CONFIDENTIAL.zip, project-chimera-CONFIDENTIAL.zip"
...
**Respuesta:** GrantS3FullAccess, DeleteUserPolicy
